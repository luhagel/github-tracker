...
class ChartTableViewController: UITableViewController {
  ...
  let testArray: [String] = [
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let currentUserCommits: Int = 200

        // Configure the cell...
      cell.contentView.addSubview(BarChartBarView(frame: CGRect(x: 20, y: 10, width: currentUserCommits, height: 20), color: .green, username: "luhagel", commits: currentUserCommits))
